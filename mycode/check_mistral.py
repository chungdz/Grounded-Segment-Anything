...
generation_output = model.generate(**input_ids, max_length=2048, temperature=0.1, top_p=0.7, do_sample=True)

print(tokenizer.batch_decode(generation_output, skip_special_tokens=True, clean_up_tokenization_spaces=False)[0])
